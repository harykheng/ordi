  ...
  return (
    <footer id="mulai" className="tear-top px-5 pt-24 pb-10" style={{ "--tear-from": "var(--color-meja)" }}>
      <div className="mx-auto max-w-6xl">
        <Reveal>
          <h2 className="font-headline text-[clamp(2.1rem,4.6vw,3.3rem)] leading-[1.06] text-balance">
            ...
            <form className="card-ink grid grid-cols-1 gap-6 p-5 sm:p-7" onSubmit={(e) => e.preventDefault()}>
              <div>
                ...
                <input
                  ...
                  className="min-h-12 w-full rounded-xl border-2 border-ink bg-card px-4 text-base placeholder:text-ink-2/80"
                />
              </div>
          ...
          <Reveal delay={0.1} className="lg:sticky lg:top-28">
            <div className="receipt px-5 pt-5 pb-6">
              ...
              <p className="mt-4 min-h-6 font-body text-sm text-ink-2">
                {tier && (
                  <>
                    <span className="pen">Kayaknya paling pas: </span>
        ...
        <div className="mt-20 border-t-2 border-dashed border-ink/25 pt-8 text-center">
