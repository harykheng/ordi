      ...
      <div className="mx-auto grid grid-cols-1 max-w-6xl items-center gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.05fr)]">
        ...
        <Reveal delay={0.1}>
          <div className="card-ink p-4 sm:p-6">
            <div role="group" aria-label="Mode toko" className="grid grid-cols-2 overflow-hidden rounded-full border border-line">
              {[
                ["harian", "Toko harian"],
                ["po", "Toko PO"],
              ].map(([m, label]) => (
              ...
              {visible.map((d) => {
                ...
                return (
                  <button
                    ...
                    className={`min-h-[62px] rounded-[10px] border px-0.5 pt-1.5 pb-1 text-center text-[11px] leading-tight transition-colors ${
                      d.closed
                        ? "striped-closed cursor-not-allowed border-line text-ink-2"
                        : d.full
                          ? "cursor-not-allowed border-line bg-card text-ink-2"
                          : selected
            ...
            <div className="mt-4 grid grid-cols-[44px_minmax(0,1fr)_auto] items-center gap-3 rounded-xl border border-line p-2.5">
              ...
              <div className="flex items-center gap-1.5">
                <button
                  ...
                  className="grid grid-cols-1 size-11 place-items-center rounded-full border border-line bg-card font-mono-label text-lg font-bold disabled:opacity-35"
                >
                  −
                </button>
                ...
                <button
                  ...
                  className="grid grid-cols-1 size-11 place-items-center rounded-full border border-line bg-highlight font-mono-label text-lg font-bold disabled:opacity-35"
                >
                  +
                </button>
              </div>
